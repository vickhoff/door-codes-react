...
function AuthenticationPage({ authType }) {
  ...
  const AUTH_CONFIG = {
    login: {
      ...
      heroMessage: {
        ...
        message:
          "Kidding, you probably have another app to remember the credentials for this site.",
      },
      formMessage: {
        title: "Welcome back!",
  ...
  return (
    <main className={styles.authContainer}>
      <Link to="/" className={styles.logoCentered}>
        <img
      ...
      <section className={`${styles.heroContainer} ${config.heroClassName}`}>
        <Link to="/">
          <img className={styles.logo} src={logoWhite} alt="GetIn logo" />
        </Link>
      ...
      <section className={styles.formContainer}>
        ...
        <Form
          ...
          key={authType}
          authType={authType}
          fields={config.formContent}
          buttons={config.buttons}
          handleSubmit={config.formSubmit}
          primaryText={config.submitText}
        />
        <p>{config.formLink}</p>
      </section>
    </main>
